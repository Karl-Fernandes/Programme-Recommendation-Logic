...
export const COMMENTARY_TEXTS = {
  ...
  'Tech Insight Programmes': "As you are two years away from graduating, every opportunity you are eligible for will be listed on the Insight Programmes tab. Tech companies offer various insight programs and early career opportunities to help you explore different areas of technology.",
  ...
  'Tech Industrial Placements First Year': "As a first-year student interested in placements, you should focus on building foundational skills and experiences. While it's early to apply for placements directly, you can prepare by researching companies, improving your CV, and gaining relevant experiences through societies or projects. You'll be in a stronger position to apply for placements in your second year.",
  ...
  'Tech Final Year No Offer Exp': "Because you have previous experience, you will be a strong candidate for off-cycle internships. These programmes have less applicants and are suitable for upcoming graduates, often converting to a full-time position.",
